...
const fallbackTranslations: Translations = {
    ...
    'restaurant': {
      ...
      'allRightsReserved': 'Created by <a href="https://happybites.io/?utm_source=happybites-plugin&utm_medium=pwa-footer&utm_campaign=created-by" target="_blank" class="text-primary">Happybites</a>.',
      'promo': ' Create your own self-hosted WordPress QR menu free.'
    },
    'language': {

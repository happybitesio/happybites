...
final class MenuService
{
    public function get_payload(): array
    {
        ...
        $parent_categories = get_terms([
            ...
            // phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_key -- sort menu items and categories by custom order.
        ...
        foreach ($parent_categories as $parent_category) {
            ...
            $parent_data['image'] = CategoryImage::for_api((int) $parent_category->term_id);
            ...
            $child_categories = get_terms([
                ...
                'orderby' => 'meta_value_num',
                // phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_key -- sort child categories by custom order.
                'meta_key' => '_menu_order',
                'order' => 'ASC',
            ]);
            ...
            foreach ($child_categories as $child_category) {
                ...
                $child_data['image'] = CategoryImage::for_api((int) $child_category->term_id);

                $child_products = get_posts([
                    'post_type' => PostTypes::POST_TYPE,
                    'posts_per_page' => -1,
                    // phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_query -- filter products by category assignment.
                    'meta_query' => [
                        [
                            'key' => '_menu_category',
                    ...
                    // phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_key -- sort products by custom order.
                    'meta_key' => '_menu_order',
                    'orderby' => 'meta_value_num',
                    'order' => 'ASC',
                ]);
        ...
        return [
            ...
            'data' => [
                ...
                /**
                 * Menu stories for the guest menu. Empty in the free plugin;
                 * HappyBites Pro supplies items through this filter.
                 *
                 * @param list<array<string, mixed>> $stories
                 */
                'stories' => (array) apply_filters('happybites_menu_stories', []),
                ...
                'settings' => [
                    ...
                    // Credit / promo links are opt-in and default off (guideline 10).
                    'show_credit' => Options::show_credit(),
                    ...MenuDisplaySettings::for_api(),
                ],
            ],
        ];
    }

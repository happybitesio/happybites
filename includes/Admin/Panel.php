...
final class Panel
{
    ...
    public function enqueue_admin_scripts($hook)
    {
        ...
        if (strpos($hook, 'happybites') !== false || $post_type === 'happybites_menu_item') {
            // React admin pages use their own bundle.
            if (isset($_GET['page'])) {
                $react_pages = ['happybites', 'happybites-manage-menu', 'happybites-settings', 'happybites-reviews'];
                if (in_array(sanitize_key(wp_unslash($_GET['page'])), $react_pages, true)) {
                    return;
                }
            }
    ...
    {
        register_setting('happybites_options', 'happybites_settings');
        register_setting('happybites_options', 'happybites_languages');
        register_setting('happybites_options', 'happybites_restaurant_info');
        register_setting('happybites_options', 'happybites_working_hours');
        register_setting('happybites_options', 'happybites_social_media');
        register_setting('happybites_options', 'happybites_colors');
        register_setting('happybites_options', 'happybites_theme_mode');
        ...
        register_setting('happybites_options', 'happybites_default_language');
        register_setting('happybites_options', 'happybites_default_currency');
    }
    ...
    {
        echo '<p>' . __('You can configure your restaurant information here.', 'happybites') . '</p>';
    }
    ...
    public function title_field_callback()
    {
        ...
        echo '<p class="description">' . __('Enter your restaurant name.', 'happybites') . '</p>';
    }
    ...
    public function logo_field_callback()
    {
        ...
        echo '<button type="button" class="button" id="upload_logo_button">' . __('Choose Logo', 'happybites') . '</button>';
        echo '<button type="button" class="button" id="remove_logo_button" style="display: ' . ($logo_url ? 'inline-block' : 'none') . ';">' . __('Remove Logo', 'happybites') . '</button>';
        echo '</div>';

        echo '<p class="description">' . __('Click "Choose Logo" to select your restaurant logo.', 'happybites') . '</p>';
    }
    ...
    public function header_bg_field_callback()
    {
        ...
        echo '<button type="button" class="button" id="upload_header_bg_button">' . __('Choose Image', 'happybites') . '</button>';
        echo '<button type="button" class="button" id="remove_header_bg_button" style="display: ' . ($bg_url ? 'inline-block' : 'none') . ';">' . __('Remove Image', 'happybites') . '</button>';
        echo '</div>';

        echo '<p class="description">' . __('Select a background image for the header area. Recommended ratio ~16:9.', 'happybites') . '</p>';
    }
    ...
    public function slogan_field_callback()
    {
        ...
        echo '<p class="description">' . __('Enter your restaurant slogan.', 'happybites') . '</p>';
    }
    ...
    {
        echo '<p>' . __('You can configure restaurant working hours here.', 'happybites') . '</p>';
    }
    ...
    public function working_hours_field_callback()
    {
        ...
        foreach ($days as $day_key => $day_name) {
            ...
            echo '<input type="checkbox" name="happybites_working_hours[' . $day_key . '][is_open]" value="1" ' . checked(1, $is_open, false) . ' />';
            echo '<label>' . $day_name . '</label>';
            echo '</div>';

            echo '<div class="time-selectors">';
            echo '<select name="happybites_working_hours[' . $day_key . '][open_time]">';
            foreach ($hours as $hour_value => $hour_label) {
                $selected = ($open_time === $hour_value) ? 'selected' : '';
                echo '<option value="' . $hour_value . '" ' . $selected . '>' . $hour_label . '</option>';
            }
            echo '</select>';

            echo '<span class="time-separator">-</span>';

            echo '<select name="happybites_working_hours[' . $day_key . '][close_time]">';
            foreach ($hours as $hour_value => $hour_label) {
                $selected = ($close_time === $hour_value) ? 'selected' : '';
                echo '<option value="' . $hour_value . '" ' . $selected . '>' . $hour_label . '</option>';
            }
            echo '</select>';
            echo '</div>';
        ...
        echo '</div>';
        echo '<p class="description">' . __('Select open days and set opening/closing times.', 'happybites') . '</p>';
    }
    ...
    {
        echo '<p>' . __('You can configure your social media links here.', 'happybites') . '</p>';
    }
    ...
    public function social_media_field_callback()
    {
        ...
        foreach ($social_media_fields as $key => $name) {
            ...
            echo '<label for="happybites_social_media_' . $key . '">' . $name . '</label>';
            echo '<input type="url" name="happybites_social_media[' . $key . ']" value="' . esc_url($url) . '" class="regular-text" />';
            echo '</div>';
        }
        echo '</div>';
    }
    ...
    {
        echo '<p>' . __('You can configure the primary colors here.', 'happybites') . '</p>';
    }
    ...
    public function active_color_field_callback()
    {
        ...
        echo '<p class="description">' . __('Primary color is used for key UI backgrounds.', 'happybites') . '</p>';
    }
    ...
    public function accent_color_field_callback()
    {
        ...
        echo '<p class="description">' . __('Accent color highlights important UI elements.', 'happybites') . '</p>';
    }
    ...
    {
        echo '<p>' . __('You can set the restaurant theme mode here.', 'happybites') . '</p>';
    }
    ...
    public function theme_mode_field_callback()
    {
        ...
        echo '<option value="light" ' . selected('light', $mode, false) . '>' . __('Light Theme', 'happybites') . '</option>';
        echo '<option value="dark" ' . selected('dark', $mode, false) . '>' . __('Dark Theme', 'happybites') . '</option>';
        echo '</select>';
        echo '<p class="description">' . __('Select the theme mode.', 'happybites') . '</p>';
    }
    ...
    {
        echo '<p>' . __('You can configure WiFi information here.', 'happybites') . '</p>';
    }
    ...
    public function wifi_ssid_field_callback()
    {
        ...
        echo '<p class="description">' . __('Enter your WiFi SSID.', 'happybites') . '</p>';
    }
    ...
    public function wifi_password_field_callback()
    {
        ...
        echo '<p class="description">' . __('Enter the WiFi password required for connection.', 'happybites') . '</p>';
    }
    ...
    {
        echo '<p>' . __('You can add additional information here.', 'happybites') . '</p>';
    }
    ...
    {
        echo '<p>' . __('You can customize your menu URL here.', 'happybites') . '</p>';
    }
    ...
    public function information_field_callback()
    {
        ...
        echo '<p class="description">' . __('Enter additional information in HTML format. You can use basic formatting.', 'happybites') . '</p>';
    }
    ...
    public function slug_field_callback()
    {
        ...
        echo '<p class="description">' . sprintf(__('Eg: If you type <code>menu</code>, URL becomes <code>%1$smenu</code>.', 'happybites'), esc_html($home_url)) . '</p>';

        echo '<div id="qrcode-container" style="margin-top:10px;"></div>';
        echo '<button type="button" id="download-qr-btn" class="button" style="margin-top:10px; display:none;">' . __('Download QR Code', 'happybites') . '</button>';

        ?>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/qrcodejs/1.0.0/qrcode.min.js"></script>
        <script>
            (function() {
                const input = document.getElementById('happybites-slug-input');
                const qrContainer = document.getElementById('qrcode-container');
                const downloadBtn = document.getElementById('download-qr-btn');

                function renderQR() {
                    const slug = input.value.trim().replace(/^\/+|\/+$/g, '');
                    const url = "<?php echo esc_js($home_url); ?>" + slug;
                    ...
                    // QR kod oluşturulması zaman alabilir, kısa gecikme ekleyelim
                    setTimeout(() => {
                        ...
                        if (img) {
                            ...
                            downloadBtn.onclick = () => {
                                ...
                                if (img.tagName.toLowerCase() === 'canvas') {
                                    ...
                                    // img etiketi ise src'sini kullan
                                    dataUrl = img.src;
                                }
                ...
                // Sayfa yüklenince QR kod üret
                renderQR();
                // Slug değiştikçe QR kodu yenile
    ...
    {
        echo '<p>' . __('Select supported languages for menu items. You can enter separate content for each language.', 'happybites') . '</p>';
    }
    ...
    public function languages_field_callback()
    {
        ...
        foreach ($available_languages as $code => $name) {
            $checked = in_array($code, $languages, true) ? ' checked' : '';
            echo '<label class="language-checkbox">';
            echo '<input type="checkbox" name="happybites_languages[]" value="' . esc_attr($code) . '"' . $checked . ' />';
    ...
    {
        if (!wp_verify_nonce($_POST['nonce'], 'happybites_sort_nonce')) {
            wp_die(__('Security check failed.', 'happybites'));
        }
    ...
    public function update_subcategory_order()
    {
        ...
        if (!current_user_can('manage_options')) {
            wp_die(__('You are not allowed to do this.', 'happybites'));
        }

        $category_id = intval($_POST['category_id']);
        $subcategories = $_POST['subcategories'] ?? array();
    ...
    {
        // Nonce kontrolü
        if (!wp_verify_nonce($_POST['nonce'], 'happybites_quick_edit_nonce')) {
            wp_die(__('Security check failed.', 'happybites'));
        }
    ...
    {
        if (!wp_verify_nonce($_POST['nonce'], 'happybites_category_nonce')) {
            wp_die(__('Security check failed.', 'happybites'));
        }

        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have permission to do this.', 'happybites'));
        }
    ...
    {
        if (!wp_verify_nonce($_POST['nonce'], 'happybites_product_nonce')) {
            wp_die(__('Security check failed.', 'happybites'));
        }
        ...
        // Debug: Kategori ID'sini logla
        error_log('HappyBites: Adding product - Category ID: ' . $category_id . ', Name: ' . $name);
        ...
        if ($category_id > 0) {
            ...
            error_log('HappyBites: Product assigned to category - Post ID: ' . $post_id . ', Category ID: ' . $category_id);
        } else {
            error_log('HappyBites: Product added without category - Post ID: ' . $post_id);
        }

...
final class Taxonomy
{
   ...
   */
    public static function enforce_max_depth($term, string $taxonomy): mixed
    {
        ...
        // phpcs:disable WordPress.Security.NonceVerification.Missing -- WordPress core verifies the taxonomy nonce before this filter.
        if (isset($_POST['parent'])) {
            $parent_raw = sanitize_text_field(wp_unslash($_POST['parent']));

            if ($parent_raw !== '-1') {
                $parent = get_term((int) $parent_raw, $taxonomy);
